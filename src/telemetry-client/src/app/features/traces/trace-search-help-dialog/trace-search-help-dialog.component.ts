  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <table class="help-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Exact root-span attribute value match</td>
          </tr>
          <tr>
            <td><strong>Contains</strong></td>
            <td><code>url:'/api/users'</code></td>
            <td>Root-span attribute value contains text</td>
          </tr>
          <tr>
      ...
      <ul class="examples">
        ...
        <li><code>http.status_code=500</code> — Traces whose root span has status code exactly 500</li>
        <li><code>http.method:POST</code> — Root-span method contains "POST"</li>
        <li><code>"place order" AND service.name=api-gateway</code> — Combine conditions</li>
      </ul>

      <div class="note info">
        <strong>Tip:</strong> Attribute searches look in the root span's attributes.
      </div>
    </mat-dialog-content>
